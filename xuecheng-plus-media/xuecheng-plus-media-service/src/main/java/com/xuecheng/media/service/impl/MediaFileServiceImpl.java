...
public class MediaFileServiceImpl implements MediaFileService {
    ...
    @Autowired
    MediaFileService currentProxy;//注入进来的接口是代理对象
    ...
    public UploadFileResultDto uploadFile(Long companyId, UploadFileParamsDto uploadFileParamsDto, String localFilePath) {
        ...
        //存储到minio中的对象名(带目录)
        String objectName = defaultFolderPath + fileMd5 + extension;//2023/10/11/md5.jpg
        //1、将文件上传到minio。需要什么参数，准备什么参数
    ...
    public RestResponse uploadChunk(String fileMd5, int chunk, String localChunkFilePath) {
        ...
        try {
            //将文件存储至minIO
            addMediaFilesToMinIO(localChunkFilePath, getMimeType(null), bucket_Files, chunkFilePath);
            return RestResponse.success(true);
        } catch (Exception ex) {
            ex.printStackTrace();
